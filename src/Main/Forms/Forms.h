...
namespace VeraCrypt
{
	...
	class MainFrameBase : public wxFrame 
	{
		...
		protected:
			...
			virtual void OnSelectStegoDirButtonClick( wxCommandEvent& event ) { event.Skip(); }
	...
	class KeyfilesPanelBase : public wxPanel 
	{
		...
		public:
			...
			KeyfilesPanelBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxPoint( 1,-1 ), const wxSize& size = wxSize( -1,-1 ), long style = wxTAB_TRAVERSAL ); 
			~KeyfilesPanelBase();
	...
	///////////////////////////////////////////////////////////////////////////////
	/// Class StegoEncoderWizardPageBase
	///////////////////////////////////////////////////////////////////////////////
	class StegoEncoderWizardPageBase : public WizardPage
	{
		private:
		...
		public:
			...
			StegoEncoderWizardPageBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxTAB_TRAVERSAL ); 
			~StegoEncoderWizardPageBase();
