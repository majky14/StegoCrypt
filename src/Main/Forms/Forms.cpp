///////////////////////////////////////////////////////////////////////////
// C++ code generated with wxFormBuilder (version Nov 17 2016)
...
MainFrameBase::MainFrameBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	VolumeGridBagSizer->Add( VolumePathComboBox, wxGBPosition( 0, 1 ), wxGBSpan( 1, 3 ), wxEXPAND|wxALL, 5 );
	...
	VolumeGridBagSizer->Add( bSizer191, wxGBPosition( 1, 2 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	...
	VolumeGridBagSizer->Add( bSizer20, wxGBPosition( 0, 4 ), wxGBSpan( 1, 1 ), wxALIGN_RIGHT, 5 );
	...
	VolumeGridBagSizer->Add( bSizer167, wxGBPosition( 1, 4 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	...
	SelectStegoDirButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MainFrameBase::OnSelectStegoDirButtonClick ), NULL, this );
...
MainFrameBase::~MainFrameBase()
{
	...
	SelectStegoDirButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MainFrameBase::OnSelectStegoDirButtonClick ), NULL, this );
...
VolumeLocationWizardPageBase::VolumeLocationWizardPageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : WizardPage( parent, id, pos, size, style )
{
	...
	SelectStegoDirButton = new wxButton( this, wxID_ANY, _("Select Directory..."), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer90->Add( SelectStegoDirButton, 0, wxALL, 5 );
	...
	SelectStegoDirButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( VolumeLocationWizardPageBase::OnSelectStegoDirButtonClick ), NULL, this );
...
VolumeLocationWizardPageBase::~VolumeLocationWizardPageBase()
{
	...
	SelectStegoDirButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( VolumeLocationWizardPageBase::OnSelectStegoDirButtonClick ), NULL, this );
...
StegoEncoderWizardPageBase::StegoEncoderWizardPageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : WizardPage( parent, id, pos, size, style )
{
	...
	StegoEncoderAlgorithmHyperlink->SetVisitedColour( wxSystemSettings::GetColour( wxSYS_COLOUR_WINDOWTEXT ) );
	...
	StegoConfigStatusStaticText = new wxStaticText( this, wxID_ANY, _("StegoStorage configured with default parameters."), wxDefaultPosition, wxDefaultSize, 0 );
	StegoConfigStatusStaticText->Wrap( -1 );
	StegoConfigStatusStaticText->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 90, true, wxEmptyString ) );
	...
	bSizer168->Add( bSizer169, 1, wxEXPAND, 5 );
